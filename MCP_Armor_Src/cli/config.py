...
def collect_provided_options(argv):
    ...
    mapping = {
        ...
        '--source-string-hash-compare': 'source_string_hash_compare', '--no-source-string-hash-compare': 'source_string_hash_compare',
        '--source-string-hash-mode': 'source_string_hash_mode',
        '--source-string-hash-inline': 'source_string_hash_inline', '--no-source-string-hash-inline': 'source_string_hash_inline',
        '--source-string-hash-inline-obfuscate': 'source_string_hash_inline_obfuscate',
        '--source-string-hash-inline-variants': 'source_string_hash_inline_variants',
        '--source-string-hash-min-length': 'source_string_hash_min_length',
        '--source-string-hash-ratio': 'source_string_hash_ratio',
        '--source-string-hash-limit': 'source_string_hash_limit',
        '--source-string-hash-exclude': 'source_string_hash_exclude',
